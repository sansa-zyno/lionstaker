...
class InstantCryptoTrading extends StatefulWidget {
  const InstantCryptoTrading({Key? key}) : super(key: key);

  @override
  State<InstantCryptoTrading> createState() => _InstantCryptoTradingState();
}

class _InstantCryptoTradingState extends State<InstantCryptoTrading> {
    ...
    return BaseUI(
      ...
      child: Column(
        children: [
          ...
          Button(text: "Fund", animate: true, context: context, callback: () {})
        ],
      ),
    ));
  }
