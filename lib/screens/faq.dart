                    ...
                    children: [
                      ListTile(
                        title: Text(
                          "What is Lionstakers?",
                          style: TextStyle(
                              color: faq1 ? buttoncolor : Colors.black),
                        ),
                        trailing: IconButton(
                            onPressed: () {
                              faq1 = !faq1;
                      ...
                      ListTile(
                        title: Text(
                          ...
                          style: TextStyle(
                              color: faq2 ? buttoncolor : Colors.black),
                        ),
                        trailing: IconButton(
                            onPressed: () {
                              faq1 = false;
                      ...
                      ListTile(
                        title: Text(
                          ...
                          style: TextStyle(
                              color: faq3 ? buttoncolor : Colors.black),
                        ),
                        trailing: IconButton(
                            onPressed: () {
                              faq1 = false;
                      ...
                      ListTile(
                        title: Text(
                          ...
                          style: TextStyle(
                              color: faq4 ? buttoncolor : Colors.black),
                        ),
                        trailing: IconButton(
                            onPressed: () {
                              faq1 = false;
                      ...
                      ListTile(
                        title: Text(
                          ...
                          style: TextStyle(
                              color: faq5 ? buttoncolor : Colors.black),
                        ),
                        trailing: IconButton(
                            onPressed: () {
                              faq1 = false;
